...
ЗАПРЕЩЁННЫЕ ШТАМПЫ И КАНЦЕЛЯРИТ (пиши как живой человек, а не бланк):
- "Обращаемся с просьбой", "Ожидаемая информация в КП", "С нетерпением ждём вашего ответа"
- "информация о возможностях сотрудничества", "рассмотреть возможность сотрудничества"
- "в кратчайшие сроки", "заранее благодарим за понимание", "надеемся на плодотворное сотрудничество"
- Пустые общие слова вместо сути: писать "оборудование"/"продукция"/"товары" там, где
  можно назвать ЧТО именно запрашивается (тип/назначение из списка товаров выше)
