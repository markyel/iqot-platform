...
- ОТПИСКА-ДЕФЛЕКТ «зайдите к нам на сайт / посмотрите, чем мы занимаемся / наш ассортимент / что сможем поставить» со ссылкой на ГЛАВНУЮ страницу (не на конкретный товар) и БЕЗ цены по запросу — это email_type="rejection" (rejection_reason: other), НЕ question. Поставщик уклонился от ответа на запрос и вопроса к НАМ не задаёт.
