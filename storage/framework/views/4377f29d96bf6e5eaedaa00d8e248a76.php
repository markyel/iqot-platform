<?php $__env->startSection('title', 'Диагностика системы'); ?>
...
<div style="max-width: 1200px; margin: 0 auto;">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $diagnostics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $diag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="admin-card">
        <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 1rem;">
            <div>
                <h2 style="font-size: 1.125rem; font-weight: 700; color: #111827; margin-bottom: 0.5rem;">
                    <?php echo e($diag['name']); ?>

                </h2>
                <p style="color: #6b7280; font-size: 0.875rem;"><?php echo e($diag['message']); ?></p>
            </div>
            <span class="status-<?php echo e($diag['status']); ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($diag['status'] === 'ok'): ?> ✓ OK
                <?php elseif($diag['status'] === 'warning'): ?> ⚠ Предупреждение
                <?php else: ?> ✗ Ошибка
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </span>
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($diag['config'])): ?>
        <div style="margin-top: 1rem;">
            <div style="font-weight: 600; color: #374151; margin-bottom: 0.5rem; font-size: 0.875rem;">Конфигурация:</div>
            <div class="code-block">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $diag['config']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div><strong><?php echo e($k); ?>:</strong> <?php echo e(empty($v) ? '(не задано)' : (strlen($v) > 80 ? substr($v, 0, 80) . '...' : $v)); ?></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($diag['details'])): ?>
        <ul class="detail-list">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $diag['details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
async function testParse() {
    ...
    try {
        const response = await fetch('<?php echo e(route("admin.diagnostics.test-parse")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.cabinet', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Boag\PhpstormProjects\iqot-platform\resources\views/admin/diagnostics/index.blade.php ENDPATH**/ ?>