        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
            <div style="background: #f9fafb; padding: 1rem; border-radius: 8px;">
                ...
                <div style="color: #10b981; font-size: 1.5rem; font-weight: 700;">
                    <?php echo e(number_format($unlockPrice, 0)); ?> ₽
                </div>
            </div>
            ...
            <div style="background: #f9fafb; padding: 1rem; border-radius: 8px;">
                ...
                <div style="color: #10b981; font-size: 1.5rem; font-weight: 700;">
                    <?php echo e(number_format($pricePerItem, 0)); ?> ₽
                </div>
            </div>
            ...
            <div style="background: #f9fafb; padding: 1rem; border-radius: 8px;">
                ...
                <div style="color: #111827; font-size: 1.5rem; font-weight: 700;">
                    <?php echo e(\App\Models\ItemPurchase::count()); ?>
            ...
            <div style="background: #f9fafb; padding: 1rem; border-radius: 8px;">
                ...
                <div style="color: #111827; font-size: 1.5rem; font-weight: 700;">
                    <?php echo e(number_format(\App\Models\ItemPurchase::sum('amount'), 2)); ?> ₽
                </div>
            </div>
        </div>
    </div>
