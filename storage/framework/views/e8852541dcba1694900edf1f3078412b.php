<?php $__env->startSection('title', 'Отчет по заявке ' . $externalRequest->request_number); ?>
...
<div style="max-width: 1600px; margin: 0 auto;">
    <div style="margin-bottom: 2rem;">
        <a href="<?php echo e(route('cabinet.my.requests.show', $request->id)); ?>" class="back-link">
            ← Назад к заявке
        </a>
        <div style="display: flex; justify-content: space-between; align-items: start; margin-top: 1rem;">
            <div>
                <h1 style="font-size: 2rem; font-weight: 700; color: #111827; margin-bottom: 0.5rem;">
                    Отчет по заявке <?php echo e($externalRequest->request_number); ?>
