...
**Интеграция AI:**
- OpenAI-совместимый прокси `ai3.lazylift.ru:8443/v1` (nginx, Алматы KZ; ранее ai2.lazylift.ru, Cloudflare Worker, `ai.lazylift.ru/v1`) — headers `Authorization: Bearer` + `X-Proxy-Key`.
