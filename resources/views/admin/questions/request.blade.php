...
@section('header', 'Вопросы по заявке #' . $requestId)
...
<div class="container">
    ...
    <div style="margin-bottom: 1.5rem;">
        <a href="{{ route('admin.manage.requests.show', $requestId) }}" class="btn btn-secondary">← Назад к заявке</a>
    </div>
    ...
    @else
        <div class="card">
            <div class="card-header">Вопросов: {{ count($questions) }}</div>
        </div>
        ...
        <div class="question-card">
            ...
            @if(!empty($question['item_name']))
                <div class="question-meta" style="margin-bottom: 1rem;">
                    ...
                    @if(!empty($question['item_brand']))
                        <span>{{ $question['item_brand'] }}</span>
                    @endif
                    @if(!empty($question['item_article']))
                        <span>Артикул: {{ $question['item_article'] }}</span>
                    @endif
                </div>
            @endif
