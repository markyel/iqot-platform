...
<x-page-header
    ...
    description="Добавление нового тарифного плана"
>
    <x-slot:actions>
...
<div style="max-width: 900px; margin: 0 auto;">
    <form action="{{ route('admin.tariff-plans.store') }}" method="POST">
        @csrf
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: var(--space-4);">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ old('price_per_item_over_limit', 0) }}"
                            required
                            min="0"
                            step="0.01"
                        >
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ old('price_per_report_over_limit', 0) }}"
                            required
                            min="0"
                            step="0.01"
                        >
                ...
                <div class="form-group">
                    <label class="checkbox-label">
                        <input
                            ...
                            class="checkbox"
                            value="1"
                            {{ old('pdf_reports_enabled') ? 'checked' : '' }}
                        >
