...
<div style="max-width: 1000px; margin: 0 auto;">
    ...
    <div class="alert alert-info d-flex justify-content-between align-items-center">
        <div><strong>Ваш баланс:</strong> <span id="available-balance">{{ number_format($availableBalance, 2) }}</span> руб.</div>
        <div><strong>Стоимость позиции:</strong> {{ number_format($pricePerItem, 2) }} руб.</div>
    </div>
    ...
    <div class="card d-none" id="step-success">
        <div class="card-body text-center py-5">
            ...
            <div class="mt-4">
                <a href="{{ route('cabinet.my.requests.create') }}" class="btn btn-primary">Создать ещё заявку</a>
                <a href="{{ route('cabinet.my.requests.index') }}" class="btn btn-outline-secondary">Мои заявки</a>
            </div>
        </div>
    </div>
